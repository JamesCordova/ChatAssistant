...
import pygame
import os, random
from main import mainEx
from settings import *

root = tk.Tk()
button_win = tk.Frame(root, width = 500, height = 25)
button_win.pack(side = tk.TOP)
embed_pygame = tk.Frame(root, width = WINDOW_WIDTH, height = WINDOW_HEIGHT)
...
random_color() 
color_button = tk.Button(button_win, text = 'random color',  command = mainEx)
